...
def plot_audio(name):
    ...
    namel = name.split('/')[1:]
    random_key = namel[-1]
    path = f'/home/astirmind/Downloads/FinalSoundWaveProject/FinalSoundWaveProject/static/{random_key}.png'
    print(path)
    plt.savefig(path)
    #plt.show()
    ...
    if im_key in listy:
        ...
        audio_bytes, nchannels, sampwidth, framerate, nframes, comptype, compname = \
            session.query(Audio.audio_bytes, Audio.nchannels, Audio.sampwidth, \
                          ...
                          == index + 1).first()
        file_path = f'/home/astirmind/Downloads/FinalSoundWaveProject/FinalSoundWaveProject/static/playback_test.wav'
    ...
    if request.method == 'POST':
        ...
        if file.filename == '':
            ...
            if query_path.split('.')[-1] in audio_extensions:
                ...
                path = "/home/astirmind/Downloads/FinalSoundWaveProject/FinalSoundWaveProject/static/playback_test.wav"
                return path
                #return render_template('index.html')
